...
class TermsOfServicePage extends Component {
  ...
  render() {
    return (
      <main id="termsOfServicePage" className="page">
        <h3>Terms of Service</h3>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Guidex's Website.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions in full. Do not continue to use Guidex's website if you do
        ...
        <h4>Cookies</h4>
        <p>
          We employ the use of cookies. By using Guidex's website you consent to
          the use of cookies in accordance with Guidex’s privacy policy.
        </p>
        <p>
        ...
        <h4>License</h4>
        <p>
          Unless otherwise stated, Guidex and/or it’s licensors own the
          intellectual property rights for all material on Guidex. All
          intellectual property rights are reserved. You may view and/or print
          pages from https://guidex.app/ for your own personal use subject to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from https://guidex.app/</li>
          <li>Sell, rent or sub-license material from https://guidex.app/</li>
          <li>
            Reproduce, duplicate or copy material from https://guidex.app/
          </li>
        </ol>
        <p>
          Redistribute content from Guidex (unless content is specifically made
          for redistribution).
        </p>
        ...
        <p>
          ...
          outweighs the absence of Guidex; and (d) where the link is in the
        ...
        <p>
          ...
          e-mail to{" "}
          <a
            href="mailto:info@guidex.app"
            title="send an email to info@guidex.app"
          >
            info@guidex.app
          </a>
        ...
        <p>
          No use of Guidex’s logo or other artwork will be allowed for linking
